...
├── vibekit-primitives.md        ← Roadmap: 150 primitives via GitHub registry (128 shipped, 85%)
...
Phases 1–9 shipped (128 items so far — 85% of the 150 roadmap, four categories complete ✨). Roadmap of all 150 in [`vibekit-primitives.md`](./vibekit-primitives.md). Browse all from the CLI:
