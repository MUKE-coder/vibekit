...
Phases 1–5 shipped (71 items so far — nearly half of the 150 roadmap). Roadmap of all 150 in [`vibekit-primitives.md`](./vibekit-primitives.md). Browse all from the CLI:
