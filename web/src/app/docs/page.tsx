...
const externalGuides = [
  ...
  { name: "VibeKit Primitives (150)", href: `${SITE.github}/blob/main/vibekit-primitives.md`, blurb: "GitHub-registry library of hooks, helpers, and small components. 128 shipped 🎉 (Phases 1–9, 85% — four categories complete). Install via `MUKE-coder/vibekit/<name>`." },
